    ...
    <div class="card-body">
        <form action="{{ route('adminguru.update', $guru->id ) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                    <input placeholder="masukan nomor hp.." type="number" class="form-control @error('no_hp') is-invalid @enderror" required name="no_hp" value="{{ $guru->no_hp }}" autocomplete="no_hp">
                    @error('no_hp')
                    <div class="invalid-feedback">
                        <strong>{{ $message }}</strong>
                    </div>
