...
<div class="card">
    <div class="card-header">
        <h4>Sunting Data Tagihan</h4>
    </div>
    <div class="card-body">
        <form action="{{ route('admintagihan.update', $tagihan->id) }}" method="post">
            @csrf
            @method("PUT")
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                    <input placeholder="masukan jumlah tagihan.." type="number" class="form-control @error('jumlah_tagihan') is-invalid @enderror" required name="jumlah_tagihan" value="{{ $tagihan->jumlah_tagihan }}" autocomplete="jumlah_tagihan">
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                    <input placeholder="masukan batas pembayaran.." type="date" class="form-control @error('batas') is-invalid @enderror" required name="batas" value="{{ $tagihan->batas }}" autocomplete="batas">
                    @error('batas')
                    <div class="invalid-feedback">
                        <strong>{{ $message }}</strong>
                    </div>
