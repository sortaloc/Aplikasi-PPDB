        ...
        <form action="{{ route('admintagihan.store') }}" method="post">
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                    <input pattern="[A-Za-z0-9 ,.]+" placeholder="masukan nama tagihan.." type="text" class="form-control @error('nama_tagihan') is-invalid @enderror" required name="nama_tagihan" value="{{ old('nama_tagihan') }}" autocomplete="nama_tagihan" autofocus>
                    @error('nama_tagihan')
