        ...
        <form action="{{ route('adminmapel.store') }}" method="post">
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                    <input pattern="[A-Za-z0-9 ,.]+" placeholder="masukan nama mapel.." type="text" class="form-control @error('nama_mapel') is-invalid @enderror" required name="nama_mapel" value="{{ old('nama_mapel') }}" autocomplete="nama_mapel" autofocus>
                    @error('nama_mapel')
