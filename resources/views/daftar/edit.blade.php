        ...
        <form action="{{ route('daftar.update', $pendaftaran->id ) }}" method="POST">
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                    <input placeholder="masukan nisn.." type="number" class="form-control @error('nisn') is-invalid @enderror" required name="nisn" value="{{ $pendaftaran->nisn }}" autocomplete="nisn">
                    @error('nisn')
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                    <textarea name="alamat" class="form-control" id="" cols="30" rows="10">{{ $pendaftaran->alamat }}</textarea>
                </div>
            </div>
            <div class="form-group row mb-4">
